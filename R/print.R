...
#' @param fmt Passed to \code{\link{coredata}} to format the time index
...
#' @param max.rows The output will contain at most \code{max.rows} rows before
#' being truncated (default 100, or \code{getOption("xts.print.max.rows")})
#' 
